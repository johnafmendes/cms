/* CLASS NAME: App_Code/HtmlHelper.cs
 * CREATED BY: John Mendes - johnafmendes@gmail.com
 * DATE CREATION: 00/00/0000 - 00:00
 * The objective this class is purify or convert html tags to pure text.
 */
using System;
...
public class HtmlHelper
{
    ...
    //html tag list and it equivalent.
    ...
    //this function convert html tag in text, altough does not works properly.
    public string HtmlStripTags(string htmlContent, bool replaceNamedEntities, bool replaceNumberedEntities)
    {
        if (htmlContent == null)
            return null;
